...
if 1==1:
           # text_line = file.readline()
            ...
            Hfile='/home/by/ML-upscaled-AIA-193--main/hicmatch_4x_aia_box4/'+Hfile
            filein='/home/by/ML-upscaled-AIA-193--main/hicmatch_4x_aia_box4/'+filein
...
#            plt.imshow(Sdo)
            ...
            #testing
            w1,w2,v1,v2=2300,2400,1140,1272
            ...
            low,High=np.log(low-low.min()+5),np.log(High-High.min()+5)
            ...
            #im1,im2=np.log(im1-im1.min()+1e-5),np.log(im2-im2.min()+1e-5)
            ...
            #+im1v,im2v=np.log(im1v-im1v.min()+1e-5),np.log(im2v-im2v.min()+1e-5)
