...
#            plt.imshow(Sdo)
            ...
            #High[750:900,800:850]=0
            #img2Out[750:900,800:850]=0
            High[w1:w2,v1:v2]=0
            low[lw1:lw2,lv1:lv2]=0
            #High=High[a2[0]:a2[-1],a1[0]:a1[-1]]
            #img2Out=img2Out[a2[0]:a2[-1],a1[0]:a1[-1]]
            ...
            #sav.append(img3Out)
            #nHigh,para=sim.array2img(High)
            #High4=resize(nHigh,(2*img3Out.shape[0],2*img3Out.shape[1]), mode='reflect',order=3)
            #High4=sim.img2array(High4,para)
            #sav.append(High4)
#            sav=np.array(sav)
            filesub=os.path.basename(Hfile)
            pickle.dump(sav, open('train_match_x4_box4_'+filesub+'.dat4', 'wb'))
            
          # SdoOrg[1425:1460,1705:1730]=0
...
#            sim.fitswrite('match_'+filesub, sav,header=None)
